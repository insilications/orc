...
%prep
%setup -q -n orc-0.4.27
pushd ..
cp -a orc-0.4.27 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1500362407
...
/usr/lib64/liborc-0.4.so.0.27.0
/usr/lib64/liborc-test-0.4.so.0
/usr/lib64/liborc-test-0.4.so.0.27.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/liborc-0.4.so.0
/usr/lib32/liborc-0.4.so.0.27.0
/usr/lib32/liborc-test-0.4.so.0
/usr/lib32/liborc-test-0.4.so.0.27.0
